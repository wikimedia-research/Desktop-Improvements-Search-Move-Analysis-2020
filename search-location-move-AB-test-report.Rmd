...
While the estimate of the effect of the new search location is 2.4% increase in search sessions initiated, the 95% confidence interval contains 1, meaning we do not have sufficient evidence to draw definitive conclusions. Note that the effect from the search move is dampened because it was only deployed to 50% of logged-in users as part of the AB test. 
